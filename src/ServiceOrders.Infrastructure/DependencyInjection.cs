...
using ServiceOrders.Application.Options;
using ServiceOrders.Domain.Repositories;
using ServiceOrders.Infrastructure.Authentication;
using ServiceOrders.Infrastructure.Email;
using ServiceOrders.Infrastructure.ExternalServices;
using ServiceOrders.Infrastructure.ExternalServices.Cnpja;
using ServiceOrders.Infrastructure.Messaging;
using ServiceOrders.Infrastructure.Persistence;
using ServiceOrders.Infrastructure.Repositories;
using ApplicationAuthentication = ServiceOrders.Application.Authentication;
using ApplicationSecurity = ServiceOrders.Application.Abstractions.Security;
...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddDbContext<ServiceOrdersDbContext>(options =>
        {
            ...
            var databaseName = configuration["Database:Name"] ?? "ServiceOrdersDb";
        ...
        services.AddScoped<IOrderOfServiceRepository, OrderOfServiceRepository>();
        ...
        services.AddScoped<ICustomInputComponentRepository, CustomInputComponentRepository>();
        services.AddScoped<IPhotoAttachmentRepository, PhotoAttachmentRepository>();
